            ...
            <div class="row">
               ...
               <div class=" col-sm-4 col-md  col-6 col">
                  ...
                  <ul class="footer_ul_amrc">
                     ...
                     <li><a href="http://localhost/callupon/Information/about-us">About us</a></li>
                     <li><a href="http://localhost/callupon/Information/term-and-condition">Terms of service</a></li>
                     <li><a href="http://localhost/callupon/Information/privacy-policy">Privacy policy</a></li>
                  </ul>
                  <!--footer_ul_amrc ends here-->
               </div>
